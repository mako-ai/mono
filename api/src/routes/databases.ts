...
databasesRoutes.get(
  ...
  async (c: AuthenticatedContext) => {
    try {
      ...
      // Transform to API response format with connection details for frontend grouping
      const databases = dbs.map((db) => ({
        ...
        // Add connection details for frontend grouping
        connection: {
        ...
        hostKey:
          db.connection.connectionString || db.connection.host || "unknown",
